...
/*   Updated: 2025/03/18 12:18:45 by aingunza         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_boot_img(t_game *game)
{
	...
	game->textures->wall = mlx_load_png("./assets/wall4.png");
	game->textures->floor = mlx_load_png("./assets/floor4.png");
	game->textures->p1 = mlx_load_png("./assets/player2.png");
	game->textures->exit = mlx_load_png("./assets/exit3.png");
